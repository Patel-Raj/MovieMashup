...
import static com.example.patel.moviemashup.GeneralFiles.TmdbStrings.TV_RATED;
...
public class FragmentTvTopRated extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_tv_top_rated,container,false);
        recyclerView = (RecyclerView) layout.findViewById(R.id.recycleListT2);
    ...
    public static String getRequestUrl(int page) {
        return PREFIX + TV_RATED +  API_KEY + LANGUAGE + PAGE + page;
    }
