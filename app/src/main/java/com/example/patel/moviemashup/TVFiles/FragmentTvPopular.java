...
import static com.example.patel.moviemashup.GeneralFiles.TmdbStrings.ONAIR;
import static com.example.patel.moviemashup.GeneralFiles.TmdbStrings.OVERVIEW;
import static com.example.patel.moviemashup.GeneralFiles.TmdbStrings.PAGE;
...
import static com.example.patel.moviemashup.GeneralFiles.TmdbStrings.RESULTS;
import static com.example.patel.moviemashup.GeneralFiles.TmdbStrings.TV_POPULAR;
...
public class FragmentTvPopular extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_tv_popular,container,false);
        recyclerView = (RecyclerView) layout.findViewById(R.id.recycleListT3);
    ...
    public static String getRequestUrl(int page) {
        return PREFIX + TV_POPULAR +  API_KEY + LANGUAGE + PAGE + page;
    }
